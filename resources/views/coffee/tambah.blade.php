                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                <div class="card-header">
                                    <h3 class="card-title">Tambah Coffee</h3>
                                </div>
                                @php
                                    $connection = mysqli_connect('localhost', 'root', '', 'coba-hpp-3');
                                    $auto = mysqli_query($connection, 'SELECT max(kd_coffee) AS max_code FROM coffees');
                                ...
                                @endphp
                                <form id="quickForm" action="{{ route('coffee.store') }}" method="POST">
                                    @csrf
                                    <div class="card-body">
